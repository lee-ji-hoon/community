...
public class TestDataInit {
    ...
    public void init() {
        ...
        boardRepository.save(new Board(null, "자유게시판", "자유게시판 제목",null, BOARD_CONTENT_VALUE, "tester", 1L, 0, LocalDateTime.now().minusHours(1), null));
         boardRepository.save(new Board(null, "정보공유게시판", "정보공유게시판 제목",null, BOARD_CONTENT_VALUE, "tester", 1L, 0, LocalDateTime.now(), null));
         boardRepository.save(new Board(null, "신입생게시판", "신입생게시판 제목",null, BOARD_CONTENT_VALUE, "ezhoon", 2L, 0, LocalDateTime.now().minusMinutes(20), null));
         boardRepository.save(new Board(null, "졸업생게시판", "졸업생게시판 제목",null, BOARD_CONTENT_VALUE, "ezhoon", 2L, 0, LocalDateTime.now().minusSeconds(40), null));
