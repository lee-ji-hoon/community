package com.community.account.validator;
...
public class SignUpFormValidator implements Validator {
    ...
    public void validate(Object object, Errors errors) {
        ...
        if (accountRepository.existsByStudentId(signUpForm.getStudentId())) {
            errors.rejectValue("studentId", "invalid.studentId", new Object[]{signUpForm.getEmail()}, "이미 가입된 학번입니다.");
        }
    }
}
