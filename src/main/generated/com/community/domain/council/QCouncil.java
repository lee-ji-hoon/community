...
public class QCouncil extends EntityPathBase<Council> {
    ...
    private static final long serialVersionUID = -1872556676L;
    ...
    public final com.community.domain.account.QAccount postWriter;
    ...
    public QCouncil(Class<? extends Council> type, PathMetadata metadata, PathInits inits) {
        ...
        this.postWriter = inits.isInitialized("postWriter") ? new com.community.domain.account.QAccount(forProperty("postWriter")) : null;
    }
