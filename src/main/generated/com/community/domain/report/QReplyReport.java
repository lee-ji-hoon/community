...
public class QReplyReport extends EntityPathBase<ReplyReport> {
    ...
    private static final long serialVersionUID = -581618532L;
    ...
    public final com.community.domain.board.QReply reply;
    ...
    public QReplyReport(Class<? extends ReplyReport> type, PathMetadata metadata, PathInits inits) {
        ...
        this.reply = inits.isInitialized("reply") ? new com.community.domain.board.QReply(forProperty("reply"), inits.get("reply")) : null;
    }
